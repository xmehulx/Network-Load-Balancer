...
def get_network_usage(interface='h4-eth0', interval=1, output_file='/home/mininet/proj/Network-Load-Balancer/Server/logging/log4.txt', status_file='/home/mininet/proj/Network-Load-Balancer/Server/status/status4.txt'):
    try:
        while True:

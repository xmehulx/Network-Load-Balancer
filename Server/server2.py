...
def get_network_usage(interface='h2-eth0', interval=1, output_file='/home/mininet/proj/Network-Load-Balancer/Server/logging/log2.txt', status_file='/home/mininet/proj/Network-Load-Balancer/Server/status/status2.txt'):
    try:
        while True:
